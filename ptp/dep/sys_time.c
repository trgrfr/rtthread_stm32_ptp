...
static char g_debug_message[20][200];
...
void setTime(const TimeInternal *time)
{
	...
	DBG("resetting system clock to %ld sec %ld nsec\n", time->seconds, time->nanoseconds);
}
...
bool  adjFreq(int32_t adj)
{
	...
	sprintf(g_debug_message[1], "PTP adjust: %ld\n", adj);

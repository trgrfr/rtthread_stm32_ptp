...
#define DEFAULT_UTC_OFFSET              36 /* 时区偏移 */
...
#define DEFAULT_PRIORITY1               128/* 默认优先级128 */
#define DEFAULT_PRIORITY2               128
#define DEFAULT_CLOCK_VARIANCE          65535 /* To be determined in 802.1AS */
#define DEFAULT_MAX_FOREIGN_RECORDS     5
#define DEFAULT_PARENTS_STATS           FALSE
#define DEFAULT_TWO_STEP_FLAG           TRUE /* TRUE bu禁用两部时间同步 */
